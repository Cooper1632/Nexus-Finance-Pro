    ...
    return (
        <div style={styles.container(position)}>
            ...
            <div style={styles.keypad}>
                <button style={{ ...styles.btn, ...styles.btnMem }} onClick={handleMC} title="Clear Memory">MC</button>
                <button style={{ ...styles.btn, ...styles.btnMem }} onClick={handleMR} title="Recall Memory">MR</button>
                <button style={{ ...styles.btn, ...styles.btnMem }} onClick={handleMMinus} title="Memory Minus">M-</button>
                <button style={{ ...styles.btn, ...styles.btnMem }} onClick={handleMPlus} title="Memory Plus">M+</button>
