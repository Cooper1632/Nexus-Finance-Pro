                    ...
                    <div style={styles.formGrid}>
                        ...
                        <div style={styles.fullWidth}>
                            ...
                            <select id="tx-account" name="account" value={formData.account} onChange={handleChange} style={{ ...styles.input, backgroundColor: '#FEF9E7' }}>
                                <option value="CELI">{t('common.account_types.celi')}</option>
                                <option value="REER">{t('common.account_types.reer')}</option>
                                <option value="CRI">{t('common.account_types.cri')}</option>
                                <option value="Non enregistré">{t('common.account_types.non_reg')}</option>
                                <option value="Autre">{t('common.account_types.other')}</option>
                            </select>
                        </div>
                    </div>
