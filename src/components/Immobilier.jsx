            ...
            <div className="responsive-dashboard-grid">
                ...
                <div style={styles.inputCardAcquisition}>
                    ...
                    <div className="fieldset-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        ...
                        <div className="input-group"><label htmlFor="hypothequeAnnuelle">{t('realestate.mortgage_payment')}</label><CurrencyInput id="hypothequeAnnuelle" name="hypothequeAnnuelle" value={localData.hypothequeAnnuelle} onChange={handleChange} placeholder="Total/An" /></div>
                        <div className="input-group"><label htmlFor="amortissementCapital">{t('realestate.capital_repayment')}</label><CurrencyInput id="amortissementCapital" name="amortissementCapital" value={localData.amortissementCapital} onChange={handleChange} placeholder="Capital" /></div>
                    </div>
                </div>
                ...
                <div style={styles.inputCardOperation}>
                    ...
                    <div className="fieldset-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        <div className="input-group"><label htmlFor="revenusBruts">{t('realestate.gross_revenue')}</label><CurrencyInput id="revenusBruts" name="revenusBruts" value={localData.revenusBruts} onChange={handleChange} placeholder="Loyers totaux" /></div>
                        ...
                        <div className="input-group">
                            ...
                            <CurrencyInput id="depensesExploitation" name="depensesExploitation" value={localData.depensesExploitation} onChange={handleChange} placeholder="Taxes, Assur..." />
                        </div>
                ...
                <div style={styles.inputCardAdvanced}>
                    ...
                    <div className="fieldset-grid" style={{ marginTop: '10px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        <div className="input-group"><label htmlFor="valeurActuelle">{t('realestate.current_value')}</label><CurrencyInput id="valeurActuelle" name="valeurActuelle" value={localData.valeurActuelle} onChange={handleChange} placeholder="Si diff. achat" /></div>
                        <div className="input-group"><label htmlFor="soldeHypothequeRestant">{t('realestate.mortgage_balance')}</label><CurrencyInput id="soldeHypothequeRestant" name="soldeHypothequeRestant" value={localData.soldeHypothequeRestant} onChange={handleChange} placeholder="Si diff. prêt init." /></div>
                    </div>
                    <div className="fieldset-grid" style={{ marginTop: '10px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        <div className="input-group"><label htmlFor="montantTotalPret">{t('realestate.total_loan_amount')}</label><CurrencyInput id="montantTotalPret" name="montantTotalPret" value={localData.montantTotalPret} onChange={handleChange} placeholder="Optionnel" /></div>
                        <div className="input-group"><label htmlFor="amortissementFiscal">{t('realestate.tax_amortization')}</label><CurrencyInput id="amortissementFiscal" name="amortissementFiscal" value={localData.amortissementFiscal} onChange={handleChange} placeholder="Optionnel" /></div>
                    </div>
                </div>
                ...
                <div style={styles.inputCardStartup}>
                    ...
                    <div className="fieldset-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                        <div className="input-group"><label htmlFor="fraisBienvenue">{t('realestate.welcome_tax')}</label><CurrencyInput id="fraisBienvenue" name="fraisBienvenue" value={localData.fraisBienvenue} onChange={handleChange} placeholder="Mutation" /></div>
                        <div className="input-group"><label htmlFor="fraisNotaire">{t('realestate.notary')}</label><CurrencyInput id="fraisNotaire" name="fraisNotaire" value={localData.fraisNotaire} onChange={handleChange} placeholder="Honoraires" /></div>
                        <div className="input-group"><label htmlFor="fraisRenovations">{t('realestate.renovations')}</label><CurrencyInput id="fraisRenovations" name="fraisRenovations" value={localData.fraisRenovations} onChange={handleChange} placeholder="Travaux initiaux" /></div>
                        ...
                        <div className="input-group">
                            ...
                            <CurrencyInput id="fraisDivers" name="fraisDivers" value={localData.fraisDivers} onChange={handleChange} placeholder="Divers" />
                        </div>
                    </div>
