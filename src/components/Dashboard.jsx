        ...
        <div className="printable-content" style={{ display: 'block' }}>
            ...
            <div style={{ width: '100%' }}>
                ...
                <div className="dashboard-container dark-panel-bg" style={{ backgroundColor: '#000000', padding: '10px', borderRadius: '16px', boxShadow: 'inset 0 0 20px rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', ...gridStyle }}>
                    ...
                    <div className="dashboard-main-card dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '1 / -1' }), display: 'grid', gridTemplateColumns: isTabletOrMobile ? 'repeat(auto-fit, minmax(200px, 1fr))' : '0.7fr 1.6fr 1fr 0.7fr', alignItems: 'center', gap: '10px', padding: '25px' }}>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '1' }), backgroundColor: '#EBF5FB', padding: '15px', display: 'grid', gridTemplateColumns: '1fr 1px 1fr', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '2' }), display: 'grid', gridTemplateColumns: '1.5fr 1fr', alignItems: 'flex-start', gap: '10px' }}>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '3' }), backgroundColor: '#FADBD8', padding: '15px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '15px', textAlign: 'center' }}>
                        <div>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '1', gridRow: 'span 2' }) }}>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '2' }), display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', background: '#FEF9E7', border: `1px solid var(--warning-color)`, minHeight: '160px' }}>
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '3' }), minHeight: '160px', padding: '15px' }}>
                        <Thermometer
                    ...
                    <div className="dashboard-card-fix" style={{ ...cardStyle, ...gridProp({ gridColumn: '2 / span 2' }), minHeight: '160px', padding: '15px', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className="card-hover-fix" style={{ ...gridProp({ gridColumn: '1' }) }}><FinancialHealthRadar scores={radarScores} onOpen={() => setOpenRadarModal(true)} /></div>
                    <div className="card-hover-fix" style={{ ...gridProp({ gridColumn: '2' }) }}><NexusScoreCard score={nexusScore.total} details={nexusScore.details} onOpen={() => setOpenScoreModal(true)} /></div>
                    <div className="card-hover-fix" style={{ ...gridProp({ gridColumn: '3' }) }}><ObjectiveCard netWorth={netWorth} onOpen={() => setOpenPatrimonyModal(true)} /></div>
